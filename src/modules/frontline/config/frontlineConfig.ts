...
export const config = {
  primary: {
    ...
    uatEU: {
      ...
      frontendBaseUrl: 'https://chatmodule.uat-eu.simpplr.xyz',
      apiBaseUrl: 'https://chatmodule-api.uat-eu.simpplr.xyz',
    ...
    uatAU: {
      ...
      frontendBaseUrl: 'https://chatmodule.uat-au.simpplr.com',
      apiBaseUrl: 'https://chatmodule-api.uat-au.simpplr.com',
      appManagerEmail: 'rakesh.yadav@simpplr.com',
      appManagerPassword: 'Test@123',
      endUserEmail: 'meenakshi.joshi+2@simpplr.com',
      endUserPassword: 'Test@123',
    ...
    prodAU: {
      ...
      promotionManagerEmail: 'arvind.singh+1@simpplr.com',
      promotionManagerPassword: '_Simp_1234',
      newUxEnabled: false,
