...
test.describe(
  ...
  () => {
    ...
    multiUserTileFixture(
      'verify Display upcoming events google calendar apptile is visible to end users after it has been added by the App Manager',
      {
    ...
    multiUserTileFixture(
      'Verify Display upcoming events google calendar apptile is visible to end users on site dashboard',
      {
        tag: [TestPriority.P1, TestGroupType.SANITY],
      },
