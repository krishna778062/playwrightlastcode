...
initializeIntegrationConfig('okta'); //integration config is initialized for primary tenant

export default defineConfig({
  ...baseConfig,
  testDir: path.join(PROJECT_ROOT, 'src', 'modules', 'integrations', 'tests', 'okta-sso'),
  ...
  projects: [
    {
      name: 'integrations-okta-chromium',
      use: {
