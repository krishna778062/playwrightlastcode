...
test.describe(
  ...
  () => {
    ...
    test(
      'TS To verify the answer of Total search volume in Search Dashboard with all filters applied',
      {
        tag: [TestPriority.P0, TestGroupType.SMOKE, TestCaseType.HERO_METRIC, '@total-search-volume'],
      },
      async () => {
        tagTest(test.info(), {
          description: 'TS To verify the answer of Total search volume in Search Dashboard with all filters applied',
          zephyrTestId: 'DE-27742',
          storyId: 'DE-25920',
        });
    ...
    test(
      'TS To verify the answer of Search click through rate in Search Dashboard with all filters applied',
      {
    ...
    // 3. No results search
    test(
      'TS To verify the answer of No results search in Search Dashboard with all filters applied',
      {
        tag: [TestPriority.P0, TestGroupType.SMOKE, TestCaseType.HERO_METRIC, '@no-results-search'],
      },
      async () => {
        tagTest(test.info(), {
          description: 'TS To verify the answer of No results search in Search Dashboard with all filters applied',
          zephyrTestId: 'DE-27764',
          storyId: 'DE-25922',
        });
    ...
    test(
      'TS To verify the answer of Average searches per logged-in user in Search Dashboard with all filters applied',
      {
    ...
    test(
      'TS To verify the answer of Search usage volume and click through rate  in Search Dashboard with all filters applied',
      {
        tag: [
          TestPriority.P0,
          TestGroupType.SMOKE,
