...
test.describe(
  ...
  () => {
    ...
    test.beforeAll('Setup Social Interaction Dashboard with custom period filter', async ({ browser }) => {
    ...
    test(
      `verify Participant engagement activity chart data validation - custom date range`,
      {
