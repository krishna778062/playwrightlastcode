...
export class AnalyticsLandingPage {
  ...
  async clickOnRecognitionAnalyticsButton(options?: TestOptions) {
    await test.step(options?.stepInfo || `Clicking Recognition Analytics button in analytics landing page`, async () => {
  ...
  async verifyAppAnalyticsButtonIsVisible(options?: TestOptions): Promise<void> {
    await test.step(options?.stepInfo || `Verifying App Analytics button is visible in analytics landing page`, async () => {
  ...
  async verifyRecognitionAnalyticsButtonIsVisible(options?: TestOptions): Promise<void> {
    await test.step(options?.stepInfo || `Verifying Recognition Analytics button is visible in analytics landing page`, async () => {
  ...
  async verifyCampaignAnalyticsButtonIsVisible(options?: TestOptions): Promise<void> {
    await test.step(options?.stepInfo || `Verifying Campaign Analytics button is visible in analytics landing page`, async () => {
