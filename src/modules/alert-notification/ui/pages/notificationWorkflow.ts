...
// export enum NotifactionFeature {
//   MUST_READ = 'mustRead',
//   FOLLOW = 'follow',
//   ALERTS = 'alerts',
// }
...
//   async selectFeatureFromListForCustomization(templateType: NotifactionFeature) {
//     await this.page.getByRole('button', { name: templateType }).click();
//   }

//   async overrideSubjectLine(customSubjectLine: string) {
//     /**
//      * 1. click on the custom subject line option
//      * 2. fill in the given subject line
...
//   async customiseNotificationTemplateForFeature(
//     feature: NotifactionFeature,
//     notificationTemplateToSelect: string,
//     options?: {
//       subjectLineToOverride?: string;
//       manageTranslations?: {
...
//   ) {
//     /**
//      * 1. verify feature is in the list
//      * 2. click on feature to expand
//      * 3. verify template is in the list for that feature
