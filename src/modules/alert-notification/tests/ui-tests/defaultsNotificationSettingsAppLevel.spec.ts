...
test.describe(
  ...
  () => {
    ...
    test(
      'tc001 - verify all the notifications tabs under Defaults application settings page',
      {
    ...
    test(
      'tc002 - Verify notification settings Email Tab at application level',
      {
        tag: [TestPriority.P1, TestGroupType.SANITY],
      },
      async () => {
    ...
    test(
      'tc003 - Verify notification settings Browser Tab at application level',
      {
        tag: [TestPriority.P1, TestGroupType.SANITY],
      },
      async () => {
    ...
    test(
      'tc004 - Verify notification settings mobile Tab at application level',
      {
        tag: [TestPriority.P1, TestGroupType.SANITY],
      },
      async () => {
    ...
    test(
      'tc005 - Verify notification settings SMS Tab at application level',
      {
        tag: [TestPriority.P1, TestGroupType.SANITY],
      },
      async () => {
    ...
    test(
      'tc006 - Verify org communication notification settings at application level for all types of notifications',
      {
        tag: [TestPriority.P1, TestGroupType.SANITY],
      },
      async () => {
    ...
    test(
      'tc007 - Verify functionality of Use Recommended button in Email section at application level',
      {
        tag: [TestPriority.P1, TestGroupType.SANITY],
      },
      async () => {
        ...
        await applicationNotificationSettingsPage.defaultNotificationSettingsComponent.uncheckMultipleCheckboxes([
          'All',
        ]);
    ...
    test(
      'tc008 - Verify functionality of Use Recommended button in browser section at application level',
      {
        tag: [TestPriority.P1, TestGroupType.SANITY],
      },
      async () => {
    ...
    test(
      'tc009 - Verify functionality of Use Recommended button in mobile section at application level',
      {
        tag: [TestPriority.P1, TestGroupType.SANITY],
      },
      async () => {
    ...
    test(
      'tc011 -Verify the functionality of All checkbox in Email Tab by checking or unchecking at application level',
      {
        tag: [TestPriority.P1, TestGroupType.SANITY],
      },
      async () => {
    ...
    test(
      'tc012 -Verify the functionality of All checkbox in Browser Tab  by checking unchecking at application level',
      {
        tag: [TestPriority.P1, TestGroupType.SANITY],
      },
      async () => {
    ...
    test(
      'tc013 -Verify the functionality of All checkbox in mobile Tab  by checking unchecking at application level',
      {
        tag: [TestPriority.P1, TestGroupType.SANITY],
      },
      async () => {
    ...
    test(
      'tc014 -Verify the functionality of All checkbox in SMS Tab  by checking unchecking at application level',
      {
        tag: [TestPriority.P1, TestGroupType.SANITY],
      },
      async () => {
    ...
    test(
      'tc015 -verify Overwrite notification settings for all users in Email Tab',
      {
      ...
      async () => {
        ...
        await applicationNotificationSettingsPage.commonActionsComponent.verifyToastMessage(
