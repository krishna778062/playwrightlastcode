...
export const config = {
  primary: {
    test: {
      ...
      internalApiBaseUrl: 'https://api-be.test.simpplr.com',
    ...
    qa: {
      ...
      internalApiBaseUrl: 'https://api-be.qa.simpplr.xyz',
      appManagerEmail: 'sonali.gupta@simpplr.com',
    ...
    uat: {
      ...
      internalApiBaseUrl: 'https://api-be.uat.simpplr.com',
      appManagerEmail: 'sonali.gupta@simpplr.com',
      appManagerPassword: 'simpplr001',
      endUserEmail: 'sonali.gupta+1@simpplr.com',
      endUserPassword: 'simpplr001',
    ...
    prodEU: {
      ...
      internalApiBaseUrl: 'https://api-be.eu.simpplr.com',
    ...
    prodUS: {
      ...
      internalApiBaseUrl: 'https://api-be.app.simpplr.com',
      appManagerEmail: 'sonali.gupta@simpplr.com',
      appManagerPassword: 'simpplr001',
      endUserEmail: 'sonali.gupta+2@simpplr.com',
      endUserPassword: 'simpplr001',
    ...
    uatEU: {
      ...
      internalApiBaseUrl: 'https://api-be.uat-eu.simpplr.com',
      appManagerEmail: 'aditya@radiansys.com',
      appManagerPassword: 'simpplr001',
      endUserEmail: 'aditya+1@radiansys.com',
      endUserPassword: 'simpplr001',
      siteManagerEmail: 'aditya+2@radiansys.com',
      siteManagerPassword: 'simpplr001',
      newUxEnabled: true,
      orgId: 'c626b91e-40e9-4ee6-90a6-476543d4925b',
      socialCampaignManagerEmail: 'aditya+3@radiansys.com',
      socialCampaignManagerPassword: 'simpplr001',
      linkedInEmail: 'Keerthana.KS@Simpplr.com',
      linkedInPassword: 'Keerthi@123',
    },
  ...
  contentAbac: {
    test: {
      ...
      b2bBaseUrl: 'https://api-be.test.simpplr.xyz',
      internalApiBaseUrl: 'https://api-be.test.simpplr.xyz',
      appManagerEmail: 'sonali.gupta@simpplr.com',
      appManagerPassword: 'simpplr001',
      endUserEmail: 'sonali.gupta+1@simpplr.com',
      endUserPassword: 'simpplr001',
  ...
  contentStudio: {
    ...
    qa: {
      tenantName: 'Content Studio',
      frontendBaseUrl: 'https://content-studio.qa.simpplr.xyz',
      apiBaseUrl: 'https://content-studio-api.qa.simpplr.xyz',
      b2bBaseUrl: 'https://api-be.qa.simpplr.xyz',
      internalApiBaseUrl: 'https://api-be.qa.simpplr.xyz',
      appManagerEmail: 'pushker.yadav@simpplr.com',
      appManagerPassword: 'Simpplr@123',
    ...
    uat: {
      tenantName: 'Content Studio',
      frontendBaseUrl: 'https://content-studio.uat.simpplr.xyz',
      apiBaseUrl: 'https://content-studio-api.uat.simpplr.xyz',
      b2bBaseUrl: 'https://api-be.app.simpplr.com',
      internalApiBaseUrl: 'https://api-be.app.simpplr.com',
      appManagerEmail: 'pushker.yadav@simpplr.com',
      appManagerPassword: 'Simpplr@123',
    ...
    prodUS: {
      tenantName: 'Content Studio',
      frontendBaseUrl: 'https://content-studio.app.simpplr.com',
      apiBaseUrl: 'https://content-studio-api.app.simpplr.com',
      b2bBaseUrl: 'https://api-be.app.simpplr.com',
      internalApiBaseUrl: 'https://api-be.app.simpplr.com',
      appManagerEmail: 'pushker.yadav@simpplr.com',
      appManagerPassword: 'Simpplr@123',
    ...
    prodEU: {
      tenantName: 'Content Studio',
      frontendBaseUrl: 'https://content-studio.eu.simpplr.com',
      apiBaseUrl: 'https://content-studio-api.eu.simpplr.com',
      b2bBaseUrl: 'https://api-be.eu.simpplr.com',
      internalApiBaseUrl: 'https://api-be.eu.simpplr.com',
      appManagerEmail: 'pushker.yadav@simpplr.com',
      appManagerPassword: 'Simpplr@123',
...
export function initializeContentConfig(tenant: TenantKey): void {
  ...
  if (configCache && configCache.currentTenant !== tenant) {
    log.debug(`🔧 Switching from tenant '${configCache.currentTenant}' to '${tenant}' (called from: ${caller})`);
  }

  log.debug(`🔧 Initializing content config for tenant: ${tenant} (called from: ${caller})`);
...
export function getContentTenantConfigFromCache(): ContentTenantConfig {
  if (!configCache) {
    const caller = getCallerInfo();
    throw new Error(
      `❌ Config not initialized! Call initializeContentConfig(tenant) first\n` +
        `Called from: ${caller}\n` +
        `Make sure your Playwright config file calls initializeContentConfig() before using this function.`
    );
  }
...
export function getContentTenantConfigFor(tenant: TenantKey): ContentTenantConfig {
  ...
  log.debug(`🔧 Initializing config for tenant: ${tenant} (called from: ${caller})`);
...
export function clearContentConfigCache(): void {
  configCache = null;
  log.debug('🔧 Content config cache cleared');
}
