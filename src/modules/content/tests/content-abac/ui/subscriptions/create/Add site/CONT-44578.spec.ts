...
test.describe('Subscription Site Creation Test Suite (ABAC)', { tag: [ContentSuiteTags.SUBSCRIPTIONS_ABAC] }, () => {
  ...
  test(
    'verify subscription member type and non mandatory can be added during public site creation for All org ',
    {
    ...
    async ({ appManagerFixture }) => {
      ...
      await manageSiteSubscriptionPageWithSite.verifySubscriptionTypeIsMembers(audienceId!, false);
