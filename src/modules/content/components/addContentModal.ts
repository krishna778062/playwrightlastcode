...
export class AddContentModalComponent extends BaseComponent {
  ...
  constructor(page: Page) {
    ...
    this.selectTemplateDropdownOption = page.locator('#template-list'); //todo - find and add the right locator here
    this.clearButtonOnSelectTemplateDropdown = page.getByLabel('Clear search'); //todo - find and add the right locator here
  }
