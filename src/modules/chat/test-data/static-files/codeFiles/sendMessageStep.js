...
(0, cucumber_1.Given)('user clicks the attachment icon in the editor toolbar', function () {
  return __awaiter(this, void 0, void 0, function* () {
    console.log('I got my third text');
    // Simulate the user clicking the attachment icon
  });
});
(0, cucumber_1.Given)('user can see the two options Choose Files and Photo Library', function () {
  return __awaiter(this, void 0, void 0, function* () {
...
(0, cucumber_1.Then)('The attachment should be displayed in the chat editor', function () {
  return __awaiter(this, void 0, void 0, function* () {
...
(0, cucumber_1.Then)(
  ...
  function () {
    return __awaiter(this, void 0, void 0, function* () {
      console.log('Message with attachment is sent successfully and appears in the chat window');
