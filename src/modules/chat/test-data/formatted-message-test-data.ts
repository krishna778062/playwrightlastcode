...
export const selectThenFormatTestData: FormattedMessageTestData[] = [
  ...
  {
    testName: 'Select text then apply bold and italic formatting',
    message: () => `This is both bold and italic message ${generateRandomNumber(6)} - ${generateRandomText()}`,
    usesBold: true,
    usesItalic: true,
    usesUnderline: false,
    ...
    testId: 'CHAT-2244',
    storyId: 'CHAT-2244',
    description: 'To verify message is selected first then bold and italic formatting can be applied',
    priority: 'P2',
    groupType: 'SMOKE',
  },
  {
    testName: 'Select text then apply all formatting',
    message: () => `This message has all formatting applied ${generateRandomNumber(6)} - ${generateRandomText()}`,
    usesBold: true,
    usesItalic: true,
    usesUnderline: true,
    ...
    storyId: 'CHAT-2265',
    description:
      'To verify text message is selected first then all formatting (bold, italic, underline, strikethrough) can be applied',
    priority: 'P2',
    groupType: 'SMOKE',
  },

  {
    testName: 'Select text then apply bullet points formatting',
    message: () =>
      `This message is for testing the bullet points  ${generateRandomNumber(6)} - ${generateRandomText()}`,
    usesBold: false,
    usesItalic: false,
    ...
    testId: 'CHAT-2266',
    storyId: 'CHAT-2266',
    description: 'To verify message is selected first then bullet points formatting can be applied',
    priority: 'P2',
    groupType: 'SMOKE',
  },

  {
    testName: 'Select text then apply ordered list formatting',
    message: () => `This message is for testing the ordered list  ${generateRandomNumber(6)} - ${generateRandomText()}`,
    usesBold: false,
    usesItalic: false,
    usesUnderline: false,
    ...
    testId: 'CHAT-2267',
    storyId: 'CHAT-2267',
    description: 'To verify message is selected first then ordered list formatting can be applied',
    priority: 'P2',
    groupType: 'SMOKE',
  },
];
