...
export const PLATFORM_API_ENDPOINTS = {
  appManagement: {
    ...
    identity: {
      ...
      v2IdentityAccessControlGroupsSubjectStatsACGId: (acgId: string) => `/v2/identity/access-control/groups/subject-stats?acgIds=${acgId}`,
    },
  },
  identity: {
    ...
    v1IdentityAccountsSecurityQuestions: 'v1/identity/accounts/securityQuestions',
