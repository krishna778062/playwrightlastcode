...
test.describe('Spot award end to end flow - audience to all employees', () => {
  ...
  [
    {
      testId: 'RC-4468',
      testTitle:
        'Validate creation of Spot award when Users in audience selected to give award to All employees for Specific period unlimited times',
    ...
    },
    {
      testId: 'RC-4465',
      testTitle:
        'Validate creation of Spot award when Users in audience selected to give award to All employees for Specific period limited times',
      giverType: 'Users in an audience',
      receiverType: 'All employees',
      selectAwardPeriodValue: 'During a specified period',
    ...
    },
    {
      testId: 'RC-4464',
      testTitle:
        'Validate creation of Spot award when Users in audience selected to give award to All employees for Indefinitely unlimited times',
      giverType: 'Users in an audience',
      receiverType: 'All employees',
    ...
    },
    {
      testId: 'RC-4362',
      testTitle:
        'Validate creation of Spot award when Users in audience selected to give award to All employees for Indefinitely limited times',
      giverType: 'Users in an audience',
      receiverType: 'All employees',
      selectAwardPeriodValue: 'Indefinitely',
      selectHowOftenAwardGivenValue: 'Limited',
