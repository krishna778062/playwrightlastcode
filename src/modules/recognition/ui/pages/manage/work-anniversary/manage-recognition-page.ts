...
export class ManageRecognitionPage extends BasePage {
  ...
  constructor(page: Page) {
    ...
    this.header = page.getByRole('heading', { name: 'Recognition', exact: true });
    ...
    this.dialogContainerForm = {
      ...
      dailogCustomiseMsgLink: dialog.getByRole('button', { name: 'Customize milestone instance message' }),
