...
initializeRecognitionConfig('ABACEnabled');
const { deviceScaleFactor, ...desktopChromeNoScale } = devices['Desktop Chrome'];

export default defineConfig({
  ...baseConfig,
  testDir: path.join(PROJECT_ROOT, 'src', 'modules', 'recognition', 'tests', 'ui-tests', 'abacEnabled'),
  ...
  projects: [
    {
      name: 'ABAC Enabled Recognition Cases',
      use: {
