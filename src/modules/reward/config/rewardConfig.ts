...
export const config = {
  primary: {
    ...
    test: {
      tenantName: 'Reward Primary',
      frontendBaseUrl: 'https://reward.test.simpplr.xyz',
      apiBaseUrl: 'https://reward-api.test.simpplr.xyz',
      appManagerEmail: 'sonu.kumar+1@simpplr.com',
      appManagerName: 'App Manager',
      appManagerUserId: 'c42b4bf9-870a-46ec-86c8-ece90b278ad9',
      appManagerPassword: 'Simpplr123',
  ...
  rewardSettings: {
    ...
    test: {
      tenantName: 'Reward Primary',
      frontendBaseUrl: 'https://reward-settings.test.simpplr.xyz',
      apiBaseUrl: 'https://reward-settings-api.test.simpplr.xyz',
      appManagerEmail: 'sonu.kumar+1@simpplr.com',
      appManagerName: 'App Manager',
      appManagerUserId: 'c42b4bf9-870a-46ec-86c8-ece90b278ad9',
      appManagerPassword: 'Simpplr123',
 ...
 * @returns Tenant configuration object
 */
export function getRewardTenantConfigFor(tenant: TenantKey): RewardTenantConfig {
  const caller = getCallerInfo();
 ...
 */
export function clearRewardConfigCache(): void {
  configCache = null;
  console.log('🔧 Reward config cache cleared');
}
 ...
 */
export function isRewardConfigInitialized(): boolean {
 ...
 */
export function getRewardConfigFromCache() {
  return {
    tenant: getRewardTenantConfigFromCache(),
    app: getAppConfig(),
  };
}
