...
import { ManageRewardsPage } from '@rewards/ui/pages/manage-rewards/manage-rewards-page';
import { RewardsDialogBox } from '@rewards/ui/pages/reward-store/rewards-dialog-box';
