...
test.describe(`form basic functionality by Application Manager`, () => {
  ...
  test('verfiy app manager able to save form in draft', async ({ appManagerPage }) => {
    tagTest(test.info(), {
  ...
  test('verify App Manager should be able to view the Homepage on clicking Forms tab', async ({ appManagerPage }) => {
    tagTest(test.info(), {
    ...
    const formCreationPage = new FormCreationPage(appManagerPage);
    // await formCreationPage.clickOnFormsTab();
    await formCreationPage.verifyThePageIsLoaded();
  ...
  test('blocks Intro Section: Verify the presence of the Intro section of the Blocks tab', async ({
    appManagerPage,
  }) => {
    tagTest(test.info(), {
      description: 'Verify App Manager should be able to view the Homepage on clicking Forms tab',
  ...
  test('blocks Text Input Section: Verify the presence of the Input field section of the Blocks tab', async ({
    appManagerPage,
  }) => {
    tagTest(test.info(), {
  ...
  test('blocks Multiple Choice Section: Verify the presence of the Multiple Choice field section of the Blocks tab', async ({
    appManagerPage,
  }) => {
    tagTest(test.info(), {
      description:
  ...
  test('block Media Section: Verify the presence of the Media field section of the Blocks tab', async ({
    appManagerPage,
  }) => {
    tagTest(test.info(), {
  ...
  test('blocks Rating and opinion fields Section: Verify the presence of the Rating and opinion fields section of the Blocks tab', async ({
    appManagerPage,
  }) => {
    tagTest(test.info(), {
      description:
  ...
  test('title and Description: Drag and Drop Title and Description component into the Canvas and verify the presence of the component', async ({
    appManagerPage,
  }) => {
    tagTest(test.info(), {
      description:
    ...
    await formCreationPage.addDescriptionIntoTitleAndDescription('Automation Test - Title & description Description');
  ...
  test('short Text: Drag and Drop Short Text component into the Canvas', async ({ appManagerPage }) => {
    tagTest(test.info(), {
  ...
  test('long Text: Drag and Drop Long Text component into the Canvas', async ({ appManagerPage }) => {
    tagTest(test.info(), {
